    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel_book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booking_hotel', to='booking_app.hotel')),
                ('room_book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booking_room', to='booking_app.room')),
            ],
        ),
        migrations.CreateModel(
            name='RoomImage',
