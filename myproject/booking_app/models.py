...
class UserProfile(AbstractUser):
    ...
    user_role = models.CharField(choices=ROLE_CHOICES, max_length=16, default='simpleUser')
...
class Hotel(models.Model):
    hotel_name = models.CharField(max_length=36)
...
class Booking(models.Model):
    hotel_book = models.ForeignKey(Hotel, on_delete=models.CASCADE, related_name='booking_hotel')
    room_book = models.ForeignKey(Room, on_delete=models.CASCADE, related_name='booking_room')
    ...
    status_book = models.CharField(choices=STATUS_BOOK_CHOICES, max_length=16)
